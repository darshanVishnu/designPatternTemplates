...
//It is also possible to instantiate new objects
// , invoke methods and get/set field values using reflection

//helps to debug the code


//List two downsides of Java Refelction
...
//  then it is preferable to avoid using it. The following concerns should be kept in mind when accessing code via reflection.

// Performance Overhead
// Because reflection involves types
//  that are dynamically resolved, certain Java virtual 
//  machine optimizations can not be performed. Consequently, 
//  reflective operations have slower performance than their non-reflective counterparts, and should be 
//  avoided in sections of code which are called frequently in performance-sensitive applications.
...
// accessing private fields and methods, the use of reflection can result in unexpected side-effects, which may 
// render code dysfunctional and may destroy portability. Reflective code breaks abstractions and therefore may change behavior with upgrades of the platform
